...
exports.config = {
    ...
    screenshotPath: './e2e/reports/errorShots/',   // Saves a screenshot to a given path if a command fails.
    //
    ...
    cucumberOpts: {
        require: ['./e2e/steps/given.js', './e2e/steps/when.js', './e2e/steps/then.js'],   // <string[]> (file/dir) require files before executing features
